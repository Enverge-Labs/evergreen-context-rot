...
def visualize_longmemeval_results(
    focused_filepath: str, full_filepath: str, model_name: str, output_path: str
):
    ...
    bars = plt.bar(
        ["Focused", "Full"],
        [focused_mean, full_mean],
        color=[focused_color, full_color],
    )
    plt.ylim(0, 1)
